...
import type { AuditResult, RedundantRead, TokenSink, ReasoningFlag, ConfigAudit, ActionItem } from './types.js';
...
export function printEfficiencyScore(result: AuditResult) {
...
export function printSummary(result: AuditResult) {
  console.log(chalk.bold('\n  Summary'));
  console.log(chalk.gray('  ──────────────────────────────────────────'));
...
export function printTopActions(actions: ActionItem[]) {
  console.log(chalk.bold('\n  Top 3 Action Items'));
  console.log(chalk.gray('  ──────────────────────────────────────────'));
...
export function printRedundantReads(reads: RedundantRead[]) {
  if (reads.length === 0) {
...
export function printTokenSinks(sinks: TokenSink[]) {
  if (sinks.length === 0) {
...
export function printReasoningFlags(flags: ReasoningFlag[]) {
  if (flags.length === 0) {
...
export function printConfigAudit(config: ConfigAudit) {
  console.log(chalk.bold('\n  Config Audit'));
  console.log(chalk.gray('  ──────────────────────────────────────────'));
